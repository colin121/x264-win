    ...
    else
    {
        ...
        if( h->param.i_lookahead_threads > 1 )
        {
            ...
            for( i = 0; i < h->param.i_lookahead_threads; i++ )
            {
				...
				{
#ifdef _MSC_VER
					x264_slicetype_slice_t s_temp = { t, a, frames, p0, p1, b, dist_scale_factor, do_search, w, output_inter[i], output_intra[i] };
#else
					x264_slicetype_slice_t s_temp = (x264_slicetype_slice_t){ t, a, frames, p0, p1, b, dist_scale_factor, do_search, w, output_inter[i], output_intra[i] };
#endif
					s[i] = s_temp;
        ...
        else
        {
			...
			{
#ifdef _MSC_VER
				x264_slicetype_slice_t s = { h, a, frames, p0, p1, b, dist_scale_factor, do_search, w, output_inter[0], output_intra[0] };
#else
				x264_slicetype_slice_t s = (x264_slicetype_slice_t){ h, a, frames, p0, p1, b, dist_scale_factor, do_search, w, output_inter[0], output_intra[0] };
#endif
